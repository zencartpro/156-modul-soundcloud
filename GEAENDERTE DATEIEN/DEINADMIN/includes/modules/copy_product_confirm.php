 ...
 * @version $Id: copy_product_confirm.php for Soundcloud 2019-09-13 08:11:16Z webchills $
 */
...
// Copy attributes to duplicate product
  ...
  if ($_POST['copy_as'] == 'link') {
    ...
    $product = $db->Execute("select products_type, products_quantity, products_model, products_image, products_soundcloud, 
    ...
    $db->Execute("INSERT INTO " . TABLE_PRODUCTS . " (products_type, products_quantity, products_model, products_image, products_soundcloud,
                  ...
                  VALUES ('" . zen_db_input($product->fields['products_type']) . "',
                          ...
                          '" . zen_db_input($product->fields['products_soundcloud']) . "',
                          '" . $products_price . "',
