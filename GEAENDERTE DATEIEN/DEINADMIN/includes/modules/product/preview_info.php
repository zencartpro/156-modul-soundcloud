 ...
 * @version $Id: preview_info.php for Soundcloud 2019-09-13 08:49:16Z webchills $
 */
...
if (zen_not_null($_POST)) {
  ...
  $product = $db->Execute("SELECT p.products_id, pd.language_id, pd.products_name, pd.products_merkmale,
                                  ...
                                  p.products_model, p.products_image, p.products_soundcloud, p.products_price, p.products_virtual,
