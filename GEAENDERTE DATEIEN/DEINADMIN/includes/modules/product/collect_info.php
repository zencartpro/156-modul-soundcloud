 ...
 * @version $Id: collect_info.php for Soundcloud 2019-09-13 08:53:50Z webchills $
 */
...
if (isset($_GET['pID']) && empty($_POST)) {
 $product = $db->Execute("SELECT pd.products_name, pd.products_merkmale, pd.products_description, pd.products_url,
                                      ...
                                      p.products_image, p.products_soundcloud, p.products_price, p.products_virtual, p.products_weight,
